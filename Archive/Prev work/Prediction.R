...
full_TreatSeek$Any_pred_initial <- logit(Any_pred_initial$fit, inverse = TRUE)
full_TreatSeek$Any_pred_initial_low <- logit(Any_pred_initial$fit + qnorm(0.025)*Any_pred_initial$se.fit, inverse = TRUE)
full_TreatSeek$Any_pred_initial_high <- logit(Any_pred_initial$fit + qnorm(0.975)*Any_pred_initial$se.fit, inverse = TRUE)

full_TreatSeek$HMIS_pred_initial <- full_TreatSeek$Any_pred_initial*logit(HMIS_pred_initial$fit, inverse = TRUE)
full_TreatSeek$HMIS_pred_initial_low <- full_TreatSeek$Any_pred_initial_low*logit(HMIS_pred_initial$fit + qnorm(0.025)*HMIS_pred_initial$se.fit, inverse = TRUE)
full_TreatSeek$HMIS_pred_initial_high <- full_TreatSeek$Any_pred_initial_high*logit(HMIS_pred_initial$fit + qnorm(0.975)*HMIS_pred_initial$se.fit, inverse = TRUE)
