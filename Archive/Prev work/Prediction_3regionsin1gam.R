...
full_TreatSeek$Time_Factor[full_TreatSeek$IHME_Region_Name == 'Southeast Asia'] <- 'Southeast Asia'
...
full_TreatSeek_n$Time_Factor[full_TreatSeek_n$IHME_Region_Name == 'Southeast Asia'] <- 'Southeast Asia'
...
clean_TreatSeek_Any$Time_Factor[clean_TreatSeek_Any$IHME_Region_Name == 'Southeast Asia'] <- 'Southeast Asia'
...
clean_TreatSeek_HMISfrac$Time_Factor[clean_TreatSeek_HMISfrac$IHME_Region_Name == 'Southeast Asia'] <- 'Southeast Asia'
...
full_TreatSeek_n$Any_pred_initial <- logit(Any_pred_initial$fit, inverse = TRUE)
full_TreatSeek_n$Any_pred_initial_low <- logit(Any_pred_initial$fit + qnorm(0.025)*Any_pred_initial$se.fit, inverse = TRUE)
full_TreatSeek_n$Any_pred_initial_high <- logit(Any_pred_initial$fit + qnorm(0.975)*Any_pred_initial$se.fit, inverse = TRUE)

full_TreatSeek_n$HMIS_pred_initial <- full_TreatSeek_n$Any_pred_initial*logit(HMIS_pred_initial$fit, inverse = TRUE)
full_TreatSeek_n$HMIS_pred_initial_low <- full_TreatSeek_n$Any_pred_initial_low*logit(HMIS_pred_initial$fit + qnorm(0.025)*HMIS_pred_initial$se.fit, inverse = TRUE)
full_TreatSeek_n$HMIS_pred_initial_high <- full_TreatSeek_n$Any_pred_initial_high*logit(HMIS_pred_initial$fit + qnorm(0.975)*HMIS_pred_initial$se.fit, inverse = TRUE)
...
full_Any_pred_raw <- logit(full_Any_pred, inverse = TRUE)
full_HMIS_pred_raw <- logit(full_HMIS_pred, inverse = TRUE)
