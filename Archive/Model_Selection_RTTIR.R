...
cov_ind <- c(24:31, 34:37, 40:46) # check covariate names.
...
# AIC_Any_order <- names(sort(AIC_Any[!(names(AIC_Any) %in% c("frac_oop_hexp", "ind_health", 'VIIRS_nighttime'))])) # Don't use frac_oop_hexp for any TS. Exclude ind_health too - strange relation with public fractions.
...
AIC_HMIS_order <- names(sort(AIC_HMIS[!(names(AIC_HMIS) %in% c("frac_oop_hexp"))])) # Don't use frac_oop_hexp, oop_hexp_cap for pub frac - strange relation.
...
formula_any <-  logit_Any ~ -1 + IHME_Region_Name + s(Year, by = IHME_Region_Name, k = 5) + s(ANC1_coverage_prop, k = 3) + s(LDI_pc, k = 3) + s(measles_vacc_cov_prop_2, k = 3)  + s(DMSP_nighttime, k = 3) + s(hospital_beds_per1000, k = 3) + s(IFD_coverage_prop, k = 3) 
...
model.select.any <- dredge(model_any, fixed=c("IHME_Region_Name", "s(Year, by = IHME_Region_Name, k = 5)"), m.lim = c(4, 9))
timetaken <- proc.time()[3] - temptime  # About 2 min.
model.select.any[1:10]

formula_HMIS <-  logit_HMIS ~ -1 + IHME_Region_Name + s(Year, by = IHME_Region_Name, k = 5)  + s(VIIRS_nighttime, k = 3) + s(accessibility, k = 3) + s(oop_hexp_cap, k = 3)  + s(IFD_coverage_prop, k = 3) + s(education_all_ages_and_sexes_pc, k = 3) + s(ANC1_coverage_prop, k = 3) + s(measles_vacc_cov_prop_2, k = 3) + s(hospital_beds_per1000, k = 3) + s(ind_health, k = 3)
...
formula_any_1 <-  logit_Any ~ -1 + IHME_Region_Name + s(Year, by = IHME_Region_Name, k = 5) + s(ANC1_coverage_prop, k = 3) + s(DMSP_nighttime, k = 3)  + s(LDI_pc, k = 3)

model_any_1 <- gam(formula_any_1, data = train_data_Any)
summary(model_any_1) # RTTIR: 80%
...
pdf(paste(graphics.path, model_no, "Any_model_smooths_1.pdf", sep = ""), width = 12, height = 12)
par(mfrow = c(3, 3))
plot(model_any_1, select = 1, ylim = c(-5, 5), xlim = c(1990, 2017)) 
plot(model_any_1, select = 2, ylim = c(-5, 5), xlim = c(1990, 2017))   
plot(model_any_1, select = 3, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_any_1, select = 4, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_any_1, select = 5, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_any_1, select = 6, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_any_1, select = 7, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_any_1, select = 8, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_any_1, select = 9, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_any_1, select = 10, ylim = c(-5, 5), xlim = c(1990, 2017))   
plot(model_any_1, select = 11, ylim = c(-5, 5), xlim = c(1990, 2017))   
plot(model_any_1, select = 12, ylim = c(-5, 5), xlim = c(1990, 2017))  
...
formula_hmis_1 <-  logit_HMIS ~ -1 + IHME_Region_Name + s(Year, by = IHME_Region_Name, k = 5) + s(accessibility, k = 3) + s(education_all_ages_and_sexes_pc, k = 3) + s(hospital_beds_per1000, k = 3) + s(IFD_coverage_prop, k = 3) + s(measles_vacc_cov_prop, k = 3)  

model_hmis_1 <- gam(formula_hmis_1, data = train_data_HMISfrac)
summary(model_hmis_1) # 69.8%.
...
par(mfrow = c(3, 3))
plot(model_hmis_1, select = 1, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_hmis_1, select = 2, ylim = c(-5, 5), xlim = c(1990, 2017))   
plot(model_hmis_1, select = 3, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_hmis_1, select = 4, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_hmis_1, select = 5, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_hmis_1, select = 6, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_hmis_1, select = 7, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_hmis_1, select = 8, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_hmis_1, select = 9, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_hmis_1, select = 10, ylim = c(-5, 5), xlim = c(1990, 2017))  
plot(model_hmis_1, select = 11, ylim = c(-5, 5), xlim = c(1990, 2017))  
